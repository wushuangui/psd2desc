...
function emitNode3x(b, ir, parentId, meta, prefabId, pathKey, prefabRootId) {
    const nodeId = b.add({
        __type__: "cc.Node",
        _name: ir.name,
        _objFlags: 0,
    ...
    for (const child of ir.children || []) {
        ...
        childIds.push(emitNode3x(b, child, nodeId, meta, prefabId, childPath, isRoot ? nodeId : prefabRootId));
    }
